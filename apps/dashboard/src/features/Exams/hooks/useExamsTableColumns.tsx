...
export const useExamsTableColumns = () => {
  ...
  return useMemo(() => [
    ...
    {
      accessorKey: 'class',
      header: `${t('exams.table.class')} - ${t('exams.table.section')}`,
      enableSorting: false,
      cell: ({ row }) => {
    ...
    },
    {
      ...
      header: t('exams.table.totalMarks'),
      enableSorting: true,
      cell: ({ row }) => {
